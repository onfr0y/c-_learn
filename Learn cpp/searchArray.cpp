...
// Function prototype: returns the index of the element if found, or -1 if not
// found
 ...
 *
 * @param array   The array to search through. Passed as const to prevent
 * modification.
 * @param size    The number of elements in the array.
 * @param element The target value to search for.
 * @return        The index of the element if found; -1 if the element is not
 * present.
 */
int searchArray(const int array[], int size, int element) {
  for (int i = 0; i < size; i++) {
